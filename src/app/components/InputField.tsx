...
export default function InputField({ onSend }: { onSend: (message: string) => void }) {
  ...
  return (
    <div className="p-4 fixed w-7/12 bottom-0">
      <div className="flex">
        <input
          type="text"
          value={input}
          ...
          className="flex-1 p-2 pl-4 rounded-3xl ml-2 text-black mr-2"
        />
        <button
          onClick={handleSend}
          className="send_button"
        >
          <svg fill="#000000" height="40px" width="20px" version="1.1" id="Layer_1" 
